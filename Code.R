...
# Goal of this project is to create simplistic machine learning models to predict global video game sales using the various variables available in our dataset.
# In-depth overview and explanation to be provided in .Rmd file

# The video game sales data that is used for this project
...
# RMSE is defined as "the standard deviation of the residuals (prediction errors)". - Statistics How To
# https://www.statisticshowto.com/probability-and-statistics/regression-analysis/rmse-root-mean-square-error/

# RMSE formula for .Rmd file
...
# Random Forest Documentation from cran.r-project.org
...
# Model 3 (SVM Linear)
# Taking a step back in my method approach to cover my bases from a linear method perspective
# This model will use the SVM Linear method in train
...
# Our final results showed that our lowest RMSE was 0.9552388 from Random Forest.
